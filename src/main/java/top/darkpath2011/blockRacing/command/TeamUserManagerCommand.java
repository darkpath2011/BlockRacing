...
import top.darkpath2011.blockRacing.ChestsUI;
 ...
 */
public class TeamUserManagerCommand extends Command {
    public TeamUserManagerCommand() {
        super("bm");
    }
    ...
    public boolean execute(CommandSender commandSender, String s, String[] strings) {
        if (commandSender instanceof Player) {
            ...
            Team team = BlockRacing.room.getPlayerTeam(player);
            if(team != null){
                ChestsUI.mainGui(player);
            } else {
